...
const zhCNMessages: TeamArchitectureMessageCatalog = Object.freeze({
  ...
  'tree.expand': '展开 {label} 的 {count} 个下属',
  'tree.collapse': '收起 {label} 的 {count} 个下属',
  'tree.fit': '适配团队架构到画布',
  'tree.reset': '重置团队架构视图',
  ...
  'detail.project': '默认项目',
  'detail.projectless': '无项目（普通聊天）',
  'detail.project-loading': '正在读取项目…',
  'detail.project-unavailable': '当前无法读取或更新项目绑定。',
  'detail.project-missing': '已绑定的项目当前不可用',
  'detail.project-save': '保存项目绑定',
  'detail.project-saved': '项目绑定已保存。',
  'detail.project-conflict': '绑定已被更改，请刷新后重试。',
  'detail.project-future-only': '仅用于新建会话，已有会话的项目和目录不会改变。',
  'detail.type': '类型',
...
const enMessages: TeamArchitectureMessageCatalog = Object.freeze({
  ...
  'tree.expand': 'Expand {count} reports under {label}',
  'tree.collapse': 'Collapse {count} reports under {label}',
  'tree.fit': 'Fit team architecture to canvas',
  'tree.reset': 'Reset team architecture view',
  ...
  'detail.project': 'Default project',
  'detail.projectless': 'No project (ordinary chat)',
  'detail.project-loading': 'Loading projects…',
  'detail.project-unavailable': 'Project bindings are unavailable.',
  'detail.project-missing': 'The bound project is unavailable',
  'detail.project-save': 'Save project binding',
  'detail.project-saved': 'Project binding saved.',
  'detail.project-conflict': 'The binding changed. Refresh and retry.',
  'detail.project-future-only': 'Applies to new Sessions only. Existing projects and directories are unchanged.',
  'detail.type': 'Type',
